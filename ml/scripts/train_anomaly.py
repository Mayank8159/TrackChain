...
Accelerated with batched feature extraction and fast minimax coreset selection.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--coreset_ratio", "--ratio", dest="coreset_ratio", type=float, default=0.08, help="Coreset subsampling ratio")
